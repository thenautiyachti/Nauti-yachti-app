...
// nearest civic address is the neighbouring house at 12198 Pearly Bay,
...
//
// SEO TODO (owner) — GENUINE CONFLICT TO RESOLVE, worth doing:
// the dock sits in Conroe 77304, but the Google Business Profile is
// registered under Montgomery, TX (locality below matches the GBP). Those are
// different cities, and 77304 is a Conroe ZIP — so a postalCode cannot be
// added here without contradicting the locality. NAP consistency between site
// and GBP is one of the strongest local-ranking signals there is, and this
// mismatch may be part of why the profile does not surface for "Lake Conroe"
// searches. Decide which city the business is officially in, make the GBP and
// this file agree, then add the matching postalCode.
const ADDRESS = {
