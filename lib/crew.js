...
const CREW = [
  ...
  },
  {
    ...
    // Still the old ID. Renaming a task means recreating it, and connector
    // approvals live on the task -- Siren publishes through Blotato, so she is
    // renamed only just after a publish run when nothing is due. Not a
    // leftover; see the manual.
    taskId: "daily-social-publisher",
    schedule: "Every day, 9:04am",
