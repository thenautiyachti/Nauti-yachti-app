...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "It depends which boat you book. The Nauti Explorer is our flagship and takes up to 14 guests, and it is the one we recommend for tubing, wakeboarding and longer charters. The Nauti Yachti takes up to 12 and is built for Party Cove, bachelor and bachelorette parties and birthdays. The Nauti Islander takes up to 8, is the most economical of the three, and is the captainless self-drive option. These limits are the legal capacity of each vessel and cannot be exceeded. If your group is larger than 14, we can run more than one boat together — ask when you inquire.",
  },
  {
  ...
  },
  {
    ...
    a: "Plan to arrive before your charter start time rather than at it, so that boarding and the safety briefing do not eat into your booked hours. For our Boatz & Glowz events, check-in is at 4:30 PM for a 5:00 PM rope-off from Scott's Ridge, which is a good guide to the kind of buffer that works. You will be given the meeting point and the arrival time when your booking is confirmed. If somebody in your group is running late, message the captain — it is much easier to work around when we know.",
    // SEO TODO (owner): there is no published standard arrival buffer for
    // regular charters (only the glow event's 4:30 PM check-in, from
  ...
  },
  {
    ...
    a: "Our boats are kept at a private gated dock off Pearl Bay in Conroe, 77304, on the west side of Lake Conroe. It is a residential dock rather than a public marina, so there is no sign to look for and no dock office — the exact address is in your booking confirmation email, so you can plan the drive, and we text you the gate code on the morning of your charter. Parking is on site, next to the dock, so you can unload straight onto the boat rather than carrying coolers across a car park. Our Boatz & Glowz events are the exception: those run from the Scott's Ridge boat ramp, and we act as your taxi to Party Cove and back. If you want the location before booking so you can plan the drive, call or text (832) 948-2912.",
