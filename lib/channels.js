...
const LEDGER_ORIGIN = {
  "Stripe (card)": "Website",
  "Cash": "Cash",
  // "CashApp Statement" is the spelling the ledger ALREADY uses — it is in
  // STATEMENT_ORIGINS in AdminView.js and predates this map. Inventing a tidier
  // "Cash App" here would have split one real channel across two origin strings,
  // which is the whole thing this map exists to prevent. Same reason PayPal maps
  // to "Paypal Statement" rather than to itself.
  //
