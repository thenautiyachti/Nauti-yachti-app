...
//
// NAP WARNING (2026-09-01): land records show the dock-side address as
// "12198 Pearl Bay COURT" (Ct), in the Water Crest community. The owner
// reported updating the Google Business Profile to say "Pearl Bay DRIVE".
// If the profile says Drive and the records say Ct, the profile is wrong, and
// a wrong street defeats the point of fixing the city. Confirm which the GBP
// actually shows and make all three agree: GBP, this file, and the FAQ.
// (Also note: it is "Pearl Bay", not "Pearly Bay" — no such street exists.)
//
